  ...
  return (
    <header className="topbar">
      ...
      <div className="topbar-right">
        ...
        {/* Wired in Phase 1 (POST /api/refresh, GET /api/reports/pdf). Disabled
            for now so they don't read as broken. */}
        <button className="btn ghost" type="button" disabled title="Coming in Phase 1">
        ...
        <button className="btn" type="button" disabled title="Coming in Phase 1">
